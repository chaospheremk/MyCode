...
Read-Host -Prompt "Remove and reinsert YubiKey, then press Enter within 5 seconds of reinserting the Yubikey" -ForegroundColor Yellow
.\ykman piv reset -f
...
Write-Host "PIV PIN was set successfully." -ForegroundColor Green
