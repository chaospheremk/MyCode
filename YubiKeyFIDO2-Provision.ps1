# This script is for provisioning a new YubiKey for a new user or a user who needs a replacement YubiKey.
# 
...
Write-Host "All applications except for FIDO2 have been disabled." -ForegroundColor Green
...
Write-Host "FIDO2 YubiKey was successfully provisioned." -ForegroundColor Green
